...
> **D-035 ütemezési kiegészítés:** a lentebb szereplő korábbi, üres vagy proposal-only céldátumokra vonatkozó állapotot a D-035 felülírja. Mind a 127 akciónak van belső céldátuma; a 2027-09-30-i repeat-audit előtti 60. nap 2027-08-01, az utolsó operatív munkanap 2027-07-30. A szakmai G1/G3 és a teljes terv G4 kapuja ettől nem zárult le.

> **Aktuális állapot (2026-08-19):** a H-001 core és az eredeti 42 akció előkészítő munkacsomagja elkészült. A lefedettségi felülvizsgálat további 85 pontos kontrollszintű intézkedési javaslatot hozott létre (A-043–A-127), így mind a 156 eltéréssel érintett követelménycsoport közvetlenül le van fedve. A 85 új tétel kontrollspecifikus végrehajtási részletesítése is elkészült: számozott checklist, mérhető acceptance criterion, evidenciaelvárás, javasolt kontrollgazda/közreműködő, G1 review-dátum és három teljesítési hullám szerepel a `data/action_execution_details.csv` fájlban. A kanonikus céldátumok emberi döntés nélkül nem változtak; G1/G2 review, a TBD belső kontrollgazdák kijelölése, az 52 technikai tétel G3 review-ja és G4 dátumjóváhagyás szükséges. A kapuk előtt biztonságosan elkészíthető H-002 local-first fejlesztési réteg elkészült. A portál-MVP a D-032/D-033 alapján öt valós W1 tételes, vezetett emberifeladat-pilottal bővült: közérthető cél, ellenőrzőlista, SharePoint-link, felelős/reviewer, kontrollált állapotátmenet, letölthető Word-munkalap, helyi csatolmány-előkészítés, automatikus SHA-256 és append-only hash-láncolt munkanyom áll rendelkezésre. A teljes végrehajtási kör korábbi emberi döntési tételeihez elkészült az egységes, nyomtatható és kézzel aláírható csomag; az új 85 tétel végleges baseline-ja a review után készíthető el. A D-034 javaslathoz elkészült a tranzakciós SQLite WAL-tárolás, a párhuzamos módosítás elleni állapotvédelem, a korábbi JSONL-adatok biztonságos átvétele, az ellenőrzött mentés, a fail-closed többfelhasználós konfiguráció, a telepítési segéd és a 16 pontos UAT-terv. A pilot hitelesített belépésig nem formális, nem zár le feladatot, nem fogad el evidenciát és nem tölt fel közvetlenül SharePointba. Éles integráció, hálózati publikálás vagy deploy nem történt; ezek G1/G2/G3 után végezhetők.
