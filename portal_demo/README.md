...
Ne nyisd meg az `alapadatok/`, `raw_exports/`, szerződés-, licenc- vagy infrastruktúra-export könyvtárakat. A runtime review-tervezetek a Gitből kizárt `portal_runtime/` könyvtárba kerülnek. Éles belső hálózati eléréshez, hitelesítéshez és deployhoz a DEF-015/DEF-020 és DEF-032 G2/G3 feladatai továbbra is kötelezők.
